    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-3xl mx-auto bg-white rounded-lg p-8">
          <h1 className="text-4xl font-bold text-slate-900 mb-6">About M Supplies</h1>
          <div className="prose prose-lg">
            <p className="text-gray-600 mb-4">
              M Supplies is Singapore's trusted supplier of premium polymailer bags for e-commerce businesses.
            </p>
            <p className="text-gray-600 mb-4">
